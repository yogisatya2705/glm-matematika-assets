(function () {
    ...
    */
    ...
    DTBox.prototype.setupHeader = function () {
        if (this.settings.config.timeOnly == true) {
          return 0;
        }
        if (!this.el.header) {
    ...
    DTBox.prototype.setHeaderContent = function () {
        ...
        if (this.settings.config.timeOnly == false) {
    ...
    DTBox.prototype.setupFooter = function() {
        if (!this.el.footer) {
            ...
            function makeRow(label, name, range, changeHandler) {
                ...
                Object.assign(slider, {step:1, min:0, max:range, name:name, type:'range', style:'margin: 0 !important;'});
